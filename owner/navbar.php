...
<nav class="navbar navbar-expand-sm navbar-light justify-content-between" style="background-color: #e3f2fd;">
  ...
  <ul class="nav navbar-nav">
    <li class="nav-item">
      <a class="nav-link" href="../owner/owner-index.php">Home</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="../scripts/about_us.php">About Us</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="../scripts/contact.php">Contact Us</a>
    </li>
  </ul>
